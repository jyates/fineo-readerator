 ...
 *
 * Closely based on the AvaticaJDbc41Factory
 */
...
public class FineoJdbc41Factory implements AvaticaFactory {
  ...
  public AvaticaConnection newConnection(
    ...
    String url,
    Properties info) {
    return new FineoJdbc41Connection(driver, factory, url, info);
  }

  public AvaticaSpecificDatabaseMetaData newDatabaseMetaData(
    AvaticaConnection connection) {
    return new FineoJdbc41Factory.AvaticaJdbc41DatabaseMetaData(connection);
  }
  ...
  public AvaticaStatement newStatement(AvaticaConnection connection,
    ...
    return new FineoJdbc41Factory.AvaticaJdbc41Statement(connection, h, resultSetType,
  ...
  public AvaticaPreparedStatement newPreparedStatement(
    ...
    int resultSetHoldability)
    throws SQLException {
    return new FineoJdbc41Factory.AvaticaJdbc41PreparedStatement(connection, h, signature,
  ...
  private static class FineoJdbc41Connection extends FineoConnection {
    FineoJdbc41Connection(UnregisteredDriver driver,
      AvaticaFactory factory,
      String url,
      Properties info) {
