...
import io.fineo.com.amazonaws.auth.internal.Profile;
import io.fineo.com.amazonaws.auth.internal.ProfileCredentialsService;
import io.fineo.com.amazonaws.auth.internal.ProfilesConfigFileLoader;
import io.fineo.com.amazonaws.auth.internal.STSProfileCredentialsServiceLoader;
...
public class ProfilesConfigFile {
    ...
    private static Map<String, Profile> loadProfiles(File file, ProfileCredentialsService profileCredentialsService) {
        return new LinkedHashMap<String, Profile>(
          ProfilesConfigFileLoader.loadProfiles(file, profileCredentialsService));
    }
